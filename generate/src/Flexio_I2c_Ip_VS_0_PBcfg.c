...
/* Check if current file and Flexio_I2c_Ip_VS_0_PBcfg.h are of the same vendor */
...
/* Check if current file and Flexio_I2c_Ip_VS_0_PBcfg.h are of the same Autosar version */
...
/* Check if current file and Flexio_I2c_Ip_VS_0_PBcfg.h are of the same Software version */
