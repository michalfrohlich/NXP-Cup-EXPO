...
#define LPTMR_ICU_IP_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C     7
#define LPTMR_ICU_IP_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C  0
#define LPTMR_ICU_IP_VS_0_PBCFG_SW_MAJOR_VERSION_C             2
...
/* Check if source file and Lptmr_Icu_Ip_Types header file are of the same vendor */
    ...
    #error "Lptmr_Icu_Ip_VS_0_PBcfg.c and Lptmr_Icu_Ip_Types.h have different vendor IDs"
#endif
/* Check if source file and Lptmr_Icu_Ip_Types header file are of the same AutoSar version */
    ...
    #error "AutoSar Version Numbers of Lptmr_Icu_Ip_VS_0_PBcfg.c and Lptmr_Icu_Ip_Types.h are different"
#endif
/* Check if source file and Lptmr_Icu_Ip_Types header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lptmr_Icu_Ip_VS_0_PBcfg.c and Lptmr_Icu_Ip_Types.h are different"
#endif
