...
/* Check if current file and Lpi2c_Ip_VS_0_PBcfg.h header file are of the same vendor */
#if (I2C_IPW_VS_0_PBCFG_MODULE_ID_C   != LPI2C_IP_VS_0_PBCFG_MODULE_ID)
    #error "I2c_Ipw_VS_0_PBcfg.c and Lpi2c_Ip_VS_0_PBcfg.h have different module ids"
#endif
...
const Lpi2c_Ipw_HwChannelConfigType I2c_Ipw_ChannelConfig0_VS_0 =
{
    &I2c_Lpi2cMasterChannel0_VS_0,
    NULL_PTR
};
