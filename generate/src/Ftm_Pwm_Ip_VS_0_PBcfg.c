...
#define FTM_PWM_IP_VS_0_PB_CFG_VENDOR_ID_C                       43
#define FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_MAJOR_VERSION_C        4
#define FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_MINOR_VERSION_C        7
#define FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_REVISION_VERSION_C     0
#define FTM_PWM_IP_VS_0_PB_CFG_SW_MAJOR_VERSION_C                2
#define FTM_PWM_IP_VS_0_PB_CFG_SW_MINOR_VERSION_C                0
#define FTM_PWM_IP_VS_0_PB_CFG_SW_PATCH_VERSION_C                0
...
#if (FTM_PWM_IP_VS_0_PB_CFG_VENDOR_ID_C != FTM_PWM_IP_CFG_VENDOR_ID)
    #error "Vendor IDs of Ftm_Pwm_Ip_VS_0_PBcfg.c and Ftm_Pwm_Ip_Cfg.h are different."
#endif

/* Check if source file and Ftm_Pwm_Ip_Cfg.h header file are of the same AUTOSAR version */
#if ((FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_MAJOR_VERSION_C    != FTM_PWM_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_MINOR_VERSION_C    != FTM_PWM_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (FTM_PWM_IP_VS_0_PB_CFG_AR_RELEASE_REVISION_VERSION_C != FTM_PWM_IP_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of Ftm_Pwm_Ip_VS_0_PBcfg.c and Ftm_Pwm_Ip_Cfg.h are different."
#endif

/* Check if source file and Ftm_Pwm_Ip_Cfg.h header file are of the same software version */
#if ((FTM_PWM_IP_VS_0_PB_CFG_SW_MAJOR_VERSION_C != FTM_PWM_IP_CFG_SW_MAJOR_VERSION) || \
     (FTM_PWM_IP_VS_0_PB_CFG_SW_MINOR_VERSION_C != FTM_PWM_IP_CFG_SW_MINOR_VERSION) || \
     (FTM_PWM_IP_VS_0_PB_CFG_SW_PATCH_VERSION_C != FTM_PWM_IP_CFG_SW_PATCH_VERSION))
    #error "Software version numbers of Ftm_Pwm_Ip_VS_0_PBcfg.c and Ftm_Pwm_Ip_Cfg.h are different."
#endif
...
const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_VS_0_SyncCfg0 =
{
    ...
    /* OutRegSync */                 FTM_PWM_IP_SYNC_ON_TRIGGER,
    /* OutMaskSync */                FTM_PWM_IP_SYNC_DISABLED,
    /* InitCounterSync */            FTM_PWM_IP_SYNC_ON_TRIGGER,
    /* CounterSync */                FTM_PWM_IP_SYNC_DISABLED
};


/* Ftm instance 0 initialization configuration */
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_VS_0_InstCfg0 =
{
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I0_Ch1 =
{
    /* ChannelId */             1U,
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I0_Ch2 =
{
    /* ChannelId */             2U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)TRUE,
...
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_VS_0_I0_ChArray[2U] =
{
    &Ftm_Pwm_Ip_VS_0_I0_Ch1,
    &Ftm_Pwm_Ip_VS_0_I0_Ch2
};

/* Ftm instance 0 User configuration structure */
const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_VS_0_UserCfg0 =
{
    /* InstanceCfg */           &Ftm_Pwm_Ip_VS_0_InstCfg0,
    /* ConfiguredChArray */     Ftm_Pwm_Ip_VS_0_I0_ChArray,
    /* NoOfConfiguredCh */      2U
#if (defined(FTM_PWM_IP_HAS_FAULT) && (FTM_PWM_IP_HAS_FAULT == STD_ON))
    ,
...
const Ftm_Pwm_Ip_SyncCfgType Ftm_Pwm_Ip_VS_0_SyncCfg3 =
{
    /* SyncMode */                   FTM_PWM_IP_SYNC_SWTRIGGER,
    /* HwSync0 */                    (boolean)FALSE,
    /* HwSync1 */                    (boolean)FALSE,
...
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_VS_0_InstCfg3 =
{
    /* ClkSrc */                FTM_PWM_IP_CLOCK_SOURCE_EXTERNALCLK,
    /* ClkPs */                 FTM_PWM_IP_CLOCK_DIV_4,
    /* AlternateclkPs */        FTM_PWM_IP_CLOCK_DIV_1,
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I3_Ch7 =
{
    /* ChannelId */             7U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)TRUE,
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I3_Ch6 =
{
    /* ChannelId */             6U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)TRUE,
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I3_Ch4 =
{
    /* ChannelId */             4U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)TRUE,
...
const Ftm_Pwm_Ip_ChannelConfigType * const Ftm_Pwm_Ip_VS_0_I3_ChArray[3U] =
{
    ...
    &Ftm_Pwm_Ip_VS_0_I3_Ch4
};

/* Ftm instance 3 User configuration structure */
const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_VS_0_UserCfg3 =
{
...
const Ftm_Pwm_Ip_InstanceCfgType Ftm_Pwm_Ip_VS_0_InstCfg2 =
{
    /* ClkSrc */                FTM_PWM_IP_CLOCK_SOURCE_EXTERNALCLK,
...
const Ftm_Pwm_Ip_ChannelConfigType Ftm_Pwm_Ip_VS_0_I2_Ch0 =
{
    /* ChannelId */             0U,
    /* ChannelMode */           FTM_PWM_IP_MODE_EDGE_ALIGNED_HIGH,
    /* ChIrqEn */               (boolean)TRUE,
...
const Ftm_Pwm_Ip_UserCfgType Ftm_Pwm_Ip_VS_0_UserCfg2 =
{
