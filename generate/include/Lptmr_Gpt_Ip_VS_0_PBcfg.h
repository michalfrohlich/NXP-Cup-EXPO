...
/**
*   @file       LPTMR_GPT_IP_VS_0_PBcfg.h
*
...
#define LPTMR_GPT_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_H     7
#define LPTMR_GPT_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_H  0
#define LPTMR_GPT_IP_SW_MAJOR_VERSION_VS_0_PBCFG_H             2
...
extern const Lptmr_Gpt_Ip_ConfigType LPTMR_0_InitConfig_PB_VS_0;
