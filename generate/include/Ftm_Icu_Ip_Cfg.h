...
#define FTM_ICU_IP_CFG_SW_MAJOR_VERSION             2
...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if header file and Ftm_Icu_Ip_VS_0_PBcfg.h file are of the same vendor */
...
/* Check if header file and Ftm_Icu_Ip_VS_0_PBcfg.h file are of the same Autosar version */
...
/* Check if header file and Ftm_Icu_Ip_VS_0_PBcfg.h file are of the same software version */
