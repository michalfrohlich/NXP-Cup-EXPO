...
#define TEENSY_LINK_S32K_CAMERA1_OFF            (18u)
#define TEENSY_LINK_S32K_STEER_RAW_OFF          (26u)
#define TEENSY_LINK_S32K_STEER_FILT_OFF         (28u)
#define TEENSY_LINK_S32K_STEER_OUT_OFF          (30u)
#define TEENSY_LINK_S32K_TARGET_SPEED_OFF       (32u)
#define TEENSY_LINK_S32K_CURRENT_SPEED_OFF      (34u)
#define TEENSY_LINK_S32K_ESC_PRIMARY_OFF        (36u)
#define TEENSY_LINK_S32K_ESC_SECONDARY_OFF      (38u)
#define TEENSY_LINK_S32K_SERVO_CMD_OFF          (40u)
#define TEENSY_LINK_S32K_ACTUATOR_FLAGS_OFF     (42u)
#define TEENSY_LINK_S32K_ULTRA_DIST_CM10_OFF    (44u)
#define TEENSY_LINK_S32K_ULTRA_AGE_MS_OFF       (46u)
#define TEENSY_LINK_S32K_ULTRA_FLAGS_OFF        (48u)
#define TEENSY_LINK_S32K_DIAG_FLAGS_OFF         (50u)
...
#define TEENSY_LINK_TEENSY_CAMERA1_OFF          (20u)
#define TEENSY_LINK_TEENSY_AX_MG_OFF            (28u)
#define TEENSY_LINK_TEENSY_AY_MG_OFF            (30u)
#define TEENSY_LINK_TEENSY_AZ_MG_OFF            (32u)
#define TEENSY_LINK_TEENSY_GX_DPS10_OFF         (34u)
#define TEENSY_LINK_TEENSY_GY_DPS10_OFF         (36u)
#define TEENSY_LINK_TEENSY_GZ_DPS10_OFF         (38u)
#define TEENSY_LINK_TEENSY_ROLL_CDEG_OFF        (40u)
#define TEENSY_LINK_TEENSY_PITCH_CDEG_OFF       (42u)
#define TEENSY_LINK_TEENSY_YAW_CDEG_OFF         (44u)
#define TEENSY_LINK_TEENSY_ACCEL_NORM_MG_OFF    (46u)
#define TEENSY_LINK_TEENSY_LATERAL_MG_OFF       (48u)
#define TEENSY_LINK_TEENSY_TEMP_C10_OFF         (50u)
#define TEENSY_LINK_TEENSY_LOGGER_FLAGS_OFF     (52u)
#define TEENSY_LINK_TEENSY_LOGGER_DROPS_OFF     (54u)
#define TEENSY_LINK_TEENSY_RX_FRAMES_OFF        (56u)
#define TEENSY_LINK_TEENSY_RX_ERRORS_OFF        (58u)
