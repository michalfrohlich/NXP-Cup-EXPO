...
#define I2C_IPW_SW_MAJOR_VERSION              2
...
#if (I2C_IPW_VENDOR_ID != LPI2C_IP_VENDOR_ID)
    #error "I2c_Ipw.h and Lpi2c_Ip.h have different vendor ids"
#endif
/* Check if current file and Lpi2c_Ip.h header file are of the same Autosar version */
#if ( (I2C_IPW_AR_RELEASE_MAJOR_VERSION     != LPI2C_IP_AR_RELEASE_MAJOR_VERSION)   || \
      (I2C_IPW_AR_RELEASE_MINOR_VERSION     != LPI2C_IP_AR_RELEASE_MINOR_VERSION)   || \
      (I2C_IPW_AR_RELEASE_REVISION_VERSION  != LPI2C_IP_AR_RELEASE_REVISION_VERSION)   \
    )
    #error "AutoSar Version Numbers of I2c_Ipw.h and Lpi2c_Ip.h are different"
#endif
/* Check if current file and Lpi2c_Ip.h header file are of the same Software version */
#if ( (I2C_IPW_SW_MAJOR_VERSION != LPI2C_IP_SW_MAJOR_VERSION) || \
      (I2C_IPW_SW_MINOR_VERSION != LPI2C_IP_SW_MINOR_VERSION) || \
      (I2C_IPW_SW_PATCH_VERSION != LPI2C_IP_SW_PATCH_VERSION)    \
    )
#error "Software Version Numbers of I2c_Ipw.h and Lpi2c_Ip.h are different"
#endif

#if (STD_ON == I2C_FLEXIO_USED)
/* Check if current file and Flexio_I2c_Ip.h header file are of the same vendor */
#if (I2C_IPW_VENDOR_ID != FLEXIO_I2C_IP_VENDOR_ID)
    #error "I2c_Ipw.h and Flexio_I2c_Ip.h have different vendor ids"
#endif
/* Check if current file and Flexio_I2c_Ip.h header file are of the same Autosar version */
#if ( (I2C_IPW_AR_RELEASE_MAJOR_VERSION     != FLEXIO_I2C_IP_AR_RELEASE_MAJOR_VERSION)   || \
      (I2C_IPW_AR_RELEASE_MINOR_VERSION     != FLEXIO_I2C_IP_AR_RELEASE_MINOR_VERSION)   || \
      (I2C_IPW_AR_RELEASE_REVISION_VERSION  != FLEXIO_I2C_IP_AR_RELEASE_REVISION_VERSION)   \
    )
    #error "AutoSar Version Numbers of I2c_Ipw.h and Flexio_I2c_Ip.h are different"
#endif
/* Check if current file and Flexio_I2c_Ip.h header file are of the same Software version */
#if ( (I2C_IPW_SW_MAJOR_VERSION != FLEXIO_I2C_IP_SW_MAJOR_VERSION) || \
      (I2C_IPW_SW_MINOR_VERSION != FLEXIO_I2C_IP_SW_MINOR_VERSION) || \
      (I2C_IPW_SW_PATCH_VERSION != FLEXIO_I2C_IP_SW_PATCH_VERSION)    \
    )
#error "Software Version Numbers of I2c_Ipw.h and Flexio_I2c_Ip.h are different"
#endif
#endif
/*==================================================================================================
*                                          CONSTANTS
