...
#if (I2C_IPW_TYPES_VENDOR_ID != I2C_VENDOR_ID_CFGDEFINES)
    #error "CDD_I2c_CfgDefines.h and I2c_Ipw_Types.h have different vendor ids"
#endif
/* Check if current file and CDD_I2c_CfgDefines header file are of the same Autosar version */
#if ((I2C_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != I2C_AR_RELEASE_MAJOR_VERSION_CFGDEFINES) ||    \
     (I2C_IPW_TYPES_AR_RELEASE_MINOR_VERSION != I2C_AR_RELEASE_MINOR_VERSION_CFGDEFINES) ||    \
     (I2C_IPW_TYPES_AR_RELEASE_REVISION_VERSION != I2C_AR_RELEASE_REVISION_VERSION_CFGDEFINES) \
    )
    #error "AutoSar Version Numbers of CDD_I2c_CfgDefines.h and I2c_Ipw_Types.h are different"
#endif
/* Check if current file and CDD_I2c_CfgDefines header file are of the same Software version */
#if ((I2C_IPW_TYPES_SW_MAJOR_VERSION != I2C_SW_MAJOR_VERSION_CFGDEFINES) || \
     (I2C_IPW_TYPES_SW_MINOR_VERSION != I2C_SW_MINOR_VERSION_CFGDEFINES) || \
     (I2C_IPW_TYPES_SW_PATCH_VERSION != I2C_SW_PATCH_VERSION_CFGDEFINES) \
    )
    #error "Software Version Numbers of CDD_I2c_CfgDefines.h and I2c_Ipw_Types.h are different"
#endif

#if (STD_ON == I2C_FLEXIO_USED)
    /* Check if current file and Flexio_I2c_Ip_Types header file are of the same vendor */
    #if (I2C_IPW_TYPES_VENDOR_ID != FLEXIO_I2C_IP_TYPES_VENDOR_ID)
        #error "Flexio_I2c_Ip_Types.h and I2c_Ipw_Types.h have different vendor ids"
    #endif
    /* Check if current file and Flexio_I2c_Ip_Types header file are of the same Autosar version */
    #if ((I2C_IPW_TYPES_AR_RELEASE_MAJOR_VERSION != FLEXIO_I2C_IP_TYPES_AR_RELEASE_MAJOR_VERSION) ||    \
        (I2C_IPW_TYPES_AR_RELEASE_MINOR_VERSION != FLEXIO_I2C_IP_TYPES_AR_RELEASE_MINOR_VERSION) ||    \
        (I2C_IPW_TYPES_AR_RELEASE_REVISION_VERSION != FLEXIO_I2C_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
        )
        #error "AutoSar Version Numbers of Flexio_I2c_Ip_Types.h and I2c_Ipw_Types.h are different"
    #endif
    /* Check if current file and Flexio_I2c_Ip_Types header file are of the same Software version */
    #if ((I2C_IPW_TYPES_SW_MAJOR_VERSION != FLEXIO_I2C_IP_TYPES_SW_MAJOR_VERSION) || \
        (I2C_IPW_TYPES_SW_MINOR_VERSION != FLEXIO_I2C_IP_TYPES_SW_MINOR_VERSION) || \
        (I2C_IPW_TYPES_SW_PATCH_VERSION != FLEXIO_I2C_IP_TYPES_SW_PATCH_VERSION) \
        )
        #error "Software Version Numbers of Flexio_I2c_Ip_Types.h and I2c_Ipw_Types.h are different"
    #endif
#endif
