...
static constexpr uint8_t TEENSY_DISPLAY_CHARACTER_ROWS = TEENSY_DISPLAY_HEIGHT_PX / 8U;
...
static constexpr uint32_t TEENSY_DISPLAY_STACK_DRIVE_REFRESH_PERIOD_MS = 250UL;
