...
class LineDetector
{
  public:
    ...
    void processDebug(const uint16_t *pixels, VisionOutput &out, LineDetectorDebugOut &debug);

  private:
    void processImpl(const uint16_t *pixels, VisionOutput &out, LineDetectorDebugOut *debug);
