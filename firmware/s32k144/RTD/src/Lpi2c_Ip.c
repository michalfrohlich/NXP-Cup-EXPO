...
#define LPI2C_IP_SW_MAJOR_VERSION_C               2
...
void Lpi2c_Ip_MasterIRQHandler(uint8 Instance)
{
    ...
    if (NULL_PTR == Lpi2c_Ip_pxMasterState[Instance])
    {
         ...
         */
        Lpi2c_Ip_pxBase[Instance]->MSR &= (uint32)0xFFFFFFFFU;
    }
    else
#endif /* LPI2C_IP_COMMON_IRQ_MASTER_AND_SLAVE */
    {
        /* The driver has been initialized */
        IsrEnable = Lpi2c_Ip_pxBase[Instance]->MIER & (LPI2C_MIER_DMIE_MASK | LPI2C_MIER_PLTIE_MASK | LPI2C_MIER_FEIE_MASK | LPI2C_MIER_ALIE_MASK | LPI2C_MIER_NDIE_MASK |
                                                       LPI2C_MIER_SDIE_MASK | LPI2C_MIER_EPIE_MASK  | LPI2C_MIER_RDIE_MASK | LPI2C_MIER_TDIE_MASK);

        IsrStatus = Lpi2c_Ip_pxBase[Instance]->MSR  & (LPI2C_MSR_DMF_MASK   | LPI2C_MSR_PLTF_MASK   | LPI2C_MSR_FEF_MASK   | LPI2C_MSR_ALF_MASK   | LPI2C_MSR_NDF_MASK |
...
void Lpi2c_Ip_SlaveIRQHandler(uint8 Instance)
{
    ...
    if (NULL_PTR == Lpi2c_Ip_pxSlaveState[Instance])
    {
         ...
         * The driver is not initialized, only clear interrupt status flag and return immediately
         */
        Lpi2c_Ip_pxBase[Instance]->SSR &= (uint32)0xFFFFFFFFU;
    }
    else
#endif /* LPI2C_IP_COMMON_IRQ_MASTER_AND_SLAVE */
    {
        /* The driver has been initialized */
#if defined(S32K3XX)
        IsrEnable = Lpi2c_Ip_pxBase[Instance]->SIER & (LPI2C_SIER_SARIE_MASK | LPI2C_SIER_GCIE_MASK | LPI2C_SIER_AM0IE_MASK | LPI2C_SIER_FEIE_MASK |
        ...
        IsrStatus = Lpi2c_Ip_pxBase[Instance]->SSR & (LPI2C_SSR_SARF_MASK | LPI2C_SSR_GCF_MASK | LPI2C_SSR_AM1F_MASK | LPI2C_SSR_AM0F_MASK | LPI2C_SSR_FEF_MASK |
