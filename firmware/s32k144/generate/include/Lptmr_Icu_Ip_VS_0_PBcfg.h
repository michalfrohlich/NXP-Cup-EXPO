...
#define LPTMR_ICU_IP_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION     7
#define LPTMR_ICU_IP_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION  0
#define LPTMR_ICU_IP_VS_0_PBCFG_SW_MAJOR_VERSION             2
...
/* Check if header file and Lptmr_Icu_Ip_Types header file are of the same vendor */
    ...
    #error "Lptmr_Icu_Ip_VS_0_PBcfg.h and Lptmr_Icu_Ip_Types.h have different vendor IDs"
#endif
/* Check if header file and Lptmr_Icu_Ip_Types header file are of the same AutoSar version */
    ...
    #error "AutoSar Version Numbers of Lptmr_Icu_Ip_VS_0_PBcfg.h and Lptmr_Icu_Ip_Types.h are different"
#endif
/* Check if header file and Lptmr_Icu_Ip_Types header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lptmr_Icu_Ip_VS_0_PBcfg.h and Lptmr_Icu_Ip_Types.h are different"
#endif
