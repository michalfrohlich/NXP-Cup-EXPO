...
/* Check if current file and Lpi2c_Ip_VS_0_PBcfg.h header file are of the same module */
#if (LPI2C_IP_CFG_MODULE_ID  != LPI2C_IP_VS_0_PBCFG_MODULE_ID)
...
#define LPI2C_IP_NUMBER_OF_MASTER_INSTANCES \
    LPI2C_IP_FIND_MAX(LPI2C_IP_NUM_MASTER_INSTANCES_USED_VS_0, \
    0 )
#define LPI2C_IP_NUMBER_OF_SLAVE_INSTANCES \
    LPI2C_IP_FIND_MAX(LPI2C_IP_NUM_SLAVE_INSTANCES_USED_VS_0, \
    0 )
