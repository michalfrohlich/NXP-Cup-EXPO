...
#define LPIT_GPT_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_H         7
#define LPIT_GPT_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_H      0
#define LPIT_GPT_IP_SW_MAJOR_VERSION_VS_0_PBCFG_H                 2
...
extern const Lpit_Gpt_Ip_ChannelConfigType LPIT_0_ChannelConfig_PB_VS_0[3U];
