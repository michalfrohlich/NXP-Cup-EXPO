...
*/
#define SpiConf_SpiChannel_TeensySpiFrameChannel    ((Spi_ChannelType)0U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_TeensySpiJob    ((Spi_JobType)0U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_TeensySpiSequence    ((Spi_SequenceType)0U)
...
*/
#define SPI_TeensySpiDevice  ((Spi_ExternalDeviceType)0u)
...
*/
#define SPI_MAIN_FUNCTION_PERIOD            (1/1000)
