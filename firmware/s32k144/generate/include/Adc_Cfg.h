...
#if (ADC_VENDOR_ID_VS_0_PBCFG != ADC_VENDOR_ID_CFG)
...
#if ((ADC_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (ADC_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_MINOR_VERSION_CFG) || \
     (ADC_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG != ADC_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#if ((ADC_SW_MAJOR_VERSION_VS_0_PBCFG != ADC_SW_MAJOR_VERSION_CFG) || \
     (ADC_SW_MINOR_VERSION_VS_0_PBCFG != ADC_SW_MINOR_VERSION_CFG) || \
     (ADC_SW_PATCH_VERSION_VS_0_PBCFG != ADC_SW_PATCH_VERSION_CFG) \
    )
