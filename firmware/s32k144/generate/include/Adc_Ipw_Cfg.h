...
/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_Types.h file are of the same Software version */
  ...
  #if (ADC_IPW_VENDOR_ID_CFG != ADC_IPW_VENDOR_ID_VS_0_PBCFG)
  ...
  #if ((ADC_IPW_AR_RELEASE_MAJOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG) || \
      (ADC_IPW_AR_RELEASE_MINOR_VERSION_CFG != ADC_IPW_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG) || \
      (ADC_IPW_AR_RELEASE_REVISION_VERSION_CFG != ADC_IPW_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG) \
      )
  ...
  #if ((ADC_IPW_SW_MAJOR_VERSION_CFG != ADC_IPW_SW_MAJOR_VERSION_VS_0_PBCFG) || \
      (ADC_IPW_SW_MINOR_VERSION_CFG != ADC_IPW_SW_MINOR_VERSION_VS_0_PBCFG) || \
      (ADC_IPW_SW_PATCH_VERSION_CFG != ADC_IPW_SW_PATCH_VERSION_VS_0_PBCFG) \
      )
