...
static Spi_BufferDescriptorType Spi_Buffer_VS_0_TeensySpiFrameChannel;
...
/* Channel Configuration for TeensySpiFrameChannel */
static const Spi_ChannelConfigType Spi_ChannelConfig_TeensySpiFrameChannel_VS_0 =
{
...
/* Spi_aChannelConfigList_VS_0 Channel Configuration */
static const Spi_ChannelsCfgType Spi_aChannelConfigList_VS_0[1] =
{
    /* TeensySpiFrameChannel */
    {
        &Spi_ChannelConfig_TeensySpiFrameChannel_VS_0
    }
};

/* Channel Assignment of Jobs */
/* TeensySpiJob */
static const Spi_ChannelType Spi_TeensySpiJob_ChannelAssignment_VS_0[1] =
{
    SpiConf_SpiChannel_TeensySpiFrameChannel
};

/* Configuration of Jobs */
/* Job Configuration for TeensySpiJob */
static const Spi_JobConfigType Spi_JobConfig_TeensySpiJob_VS_0 =
{
        (Spi_ChannelType)1U, /* NumChannels field */
        Spi_TeensySpiJob_ChannelAssignment_VS_0, /* List of Channels */
        ...
        CSIB0, /* HWUnit index */
        SPI_TeensySpiDevice, /* External Device */
        &Spi_aExternalDeviceConfigList_VS_0[SPI_TeensySpiDevice] /* ExternalDeviceConfig - pointer to the external device configuration */
};
/* Spi_aJobConfigList_VS_0 Job Configuration*/
static const Spi_JobsCfgType Spi_aJobConfigList_VS_0[1] =
{
    /* TeensySpiJob */
    {
        &Spi_JobConfig_TeensySpiJob_VS_0
    }
};

/* Job Assignment of Sequences  */
/* TeensySpiSequence */
static const Spi_JobType Spi_TeensySpiSequence_JobAssignment_VS_0[1] =
{
    SpiConf_SpiJob_TeensySpiJob 
};

/* Configuration of Sequences */
/* Sequence Configuration for TeensySpiSequence */
static const Spi_SequenceConfigType Spi_SequenceConfig_TeensySpiSequence_VS_0 =
{
        (Spi_JobType)1U,  /* Number of Job in Seq */
        SPI_SPURIOUS_CORE_ID_U32,
        Spi_TeensySpiSequence_JobAssignment_VS_0, /* List of Jobs */
        NULL_PTR, /* End Notification */
...
/* Spi_aSequenceConfigList_VS_0 Sequence Configuration */
static const Spi_SeqsConfigType Spi_aSequenceConfigList_VS_0[1] =
{
    /* TeensySpiSequence */
    {
        &Spi_SequenceConfig_TeensySpiSequence_VS_0
    }
};
/*==================================================================================================
*                                      GLOBAL CONSTANTS
...
static const Spi_ConfigType Spi_Config=
{
    ...
    Spi_aChannelConfigList_VS_0, /* ChannelConfig */
    Spi_aJobConfigList_VS_0, /* JobConfig */
    Spi_aSequenceConfigList_VS_0, /* SequenceConfig */
    Spi_aExternalDeviceConfigList_VS_0, /* ExternalDeviceConfig */
    Spi_aHwUnitConfigList_VS_0 /* HWUnitConfig */
#if (SPI_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
