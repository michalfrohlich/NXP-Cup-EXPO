...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Flexio_Spi_Ip_VS_0_PBcfg source file and Spi configuration header file are of the same vendor */
    ...
    #error "AutoSar Version Numbers of Flexio_Spi_Ip__VS_0_PBcfg.h and Flexio_Spi_Ip.h are different"
#endif
