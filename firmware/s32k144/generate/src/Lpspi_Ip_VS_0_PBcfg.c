...
#define LPSPI_IP_VS_0_AR_RELEASE_MINOR_VERSION_PBCFG_C         7
#define LPSPI_IP_VS_0_AR_RELEASE_REVISION_VERSION_PBCFG_C      0
#define LPSPI_IP_VS_0_SW_MAJOR_VERSION_PBCFG_C                 2
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Lpspi_Ip.h and Lpspi_Ip_VS_0_PBcfg.c are of the same vendor */
#if (LPSPI_IP_VENDOR_ID != LPSPI_IP_VS_0_VENDOR_ID_PBCFG_C)
    #error "Lpspi_Ip.h and Lpspi_Ip_VS_0_PBcfg.c have different vendor ids"
#endif
/* Check if Lpspi_Ip.h file and Lpspi_Ip_VS_0_PBcfg.c file are of the same Autosar version */
...
#error "AutoSar Version Numbers of Lpspi_Ip.h and Lpspi_Ip_VS_0_PBcfg.c are different"
#endif
...
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_VS_0_PBcfg.c are different"
#endif
        ...
        #error "AutoSar Version Numbers of Lpspi_Ip_VS_0_PBcfg.c and Dma_Ip.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
/* Lpspi_Ip_DeviceParamsCfg_VS_0 Device Attribute Configuration of Spi*/
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_TeensySpiDevice Device Attribute Configuration of Spi*/
...
/* SPI controller TeensySpiPhyUnit configuration. */
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_TeensySpiPhyUnit_Instance_1_VS_0 =
{
    1U,  /* Instance */
     /* CR */
    (uint32)0,
