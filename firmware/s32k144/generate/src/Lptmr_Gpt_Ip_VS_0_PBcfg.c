 ...
 *================================================================================================*/
    ...
    #error "Lptmr_Gpt_Ip__VS_0_PBcfg.c and Lptmr_Gpt_Ip__VS_0_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Lptmr_Gpt_Ip__VS_0_PBcfg.c and Lptmr_Gpt_Ip__VS_0_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
    ...
    #error "Software Version Numbers of Lptmr_Gpt_Ip__VS_0_PBcfg.c and Lptmr_Gpt_Ip__VS_0_PBcfg.h are different"
#endif
...
const Lptmr_Gpt_Ip_ConfigType LPTMR_0_InitConfig_PB_VS_0 =
{
    /** @brief PrescalerEnable */
    (boolean)TRUE,
    #if (LPTMR_GPT_IP_SET_CLOCK_MODE == STD_ON)
    /** @brief clockAlternatePrescaler */
    0U,
    #endif    /** @brief Prescaler value */
    1U,
    /** @brief LPtimer clock source */
    LPTMR_GPT_IP_CLOCK_PCC_LPTMR0,
    /** @brief LPtimer callback name */
    &Gpt_ProcessCommonInterrupt,
    /** @brief LPtimer callbackparam  */
    (uint8)0U,
       /** @brief LPtimer channelMode  */
