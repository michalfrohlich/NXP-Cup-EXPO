...
#include "Spi_MemMap.h"
/* External device configuration for TeensySpiDevice */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_TeensySpiDevice_VS_0 =
{
    SPI_OVER_LPSPI, /* IpType */
    1U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_TeensySpiDevice_Instance_1_VS_0, /* Lpspi IP Config */
...
const Spi_ExDevicesConfigType Spi_aExternalDeviceConfigList_VS_0[1U] = 
{
    /* TeensySpiDevice */
    {
        &Spi_ExternalDeviceConfig_TeensySpiDevice_VS_0
    }
};
/* Hardware unit device configuration for TeensySpiPhyUnit*/
static const Spi_HWUnitConfigType Spi_HwUnitConfig_TeensySpiPhyUnit_VS_0 =
{
        SPI_OVER_LPSPI, /* IpType */
        1U, /* Instance */
        SPI_SPURIOUS_CORE_ID_U32, /* Core Id */
        {
            &Lpspi_Ip_PhyUnitConfig_TeensySpiPhyUnit_Instance_1_VS_0 /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
...
const Spi_PhyUnitsConfigType Spi_aHwUnitConfigList_VS_0[SPI_MAX_HWUNIT] =
{
    /* TeensySpiPhyUnit */
    {
        &Spi_HwUnitConfig_TeensySpiPhyUnit_VS_0
    }
};
